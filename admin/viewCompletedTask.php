    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        <h4 class="card-title">All Completed Task</h4>
                        ...
                        <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                        $n = 1;
                                        $select_qry = "SELECT task.Id,task.project_name,task.task_name,task.requirements,task.active,task.attachment,task.task_status,task.start_date,project.project_name,users.first_name,users.last_name
                                                   FROM task
                                                   INNER JOIN users ON users.Id = task.task_employee
                                                   INNER JOIN project ON project.code =task.project_name
                                                   WHERE task.task_status='Complete'"; 
